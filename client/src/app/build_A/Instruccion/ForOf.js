...
class ForOf extends Node_1.Node {
    ...
    execute(table, tree) {
        ...
        let simbol;
        simbol = new Simbol_1.Simbol(new Types_1.Type(Types_1.types.NUMERIC), this.declaracion, null, true, null, null, this.line, this.columna);
        ...
        for (simval of varval) {
            simbol.value = simval;
            tree.generar_3d("", simval + "", "", "t" + tree.temp);
            tree.temp++;
